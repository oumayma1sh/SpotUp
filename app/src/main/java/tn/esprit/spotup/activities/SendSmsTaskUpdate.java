...
public class SendSmsTaskUpdate extends AsyncTask<Void, Void, String> {

    private static final String TAG = "SendSmsTaskUpdate";
    ...
    // Constructor to accept both eventTitle and newEventDate
    public SendSmsTaskUpdate(String eventTitle, String newEventDate) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        // Create the message with the event title and the new event date
        String jsonBody = "{\"messages\":[{\"destinations\":[{\"to\":\"+21621845071\"}],\"from\":\"BONPLAN\",\"text\":\"The event \\\""
                + eventTitle + "\\\" has been rescheduled to " + newEventDate + ". We hope to see you there!\"}]}";
